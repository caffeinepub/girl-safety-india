  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        saffron: {
          DEFAULT: 'oklch(0.75 0.16 55)',
          light: 'oklch(0.94 0.06 75)',
          dark: 'oklch(0.62 0.18 45)',
        },
        teal: {
          DEFAULT: 'oklch(0.42 0.1 195)',
          light: 'oklch(0.62 0.1 195)',
          dark: 'oklch(0.32 0.1 195)',
        },
        cream: 'oklch(0.98 0.008 85)',
        sos: {
          DEFAULT: 'oklch(0.55 0.22 25)',
          light: 'oklch(0.75 0.18 25)',
          dark: 'oklch(0.42 0.22 25)',
        },
      },
      borderRadius: {
      ...
      boxShadow: {
        ...
        saffron: '0 4px 16px 0 oklch(0.75 0.16 55 / 0.3)',
        teal: '0 4px 16px 0 oklch(0.42 0.1 195 / 0.3)',
        sos: '0 4px 20px 0 oklch(0.55 0.22 25 / 0.4)',
      },
      keyframes: {
